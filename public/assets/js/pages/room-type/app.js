$(document).ready(function() {
    ...
    if(check.length > 0) {
        ...
        for (let i = 0; i < check.length; i++) {
            ...
            const valueInput = element.dataset.quantity_equipment;
            console.log(element.dataset.quantity_equipment);
            ...
            if(main) {
                ...
                childElement.innerHTML = `<div class="mdl-textfield mdl-js-textfield mdl-textfield--floating-label txt-full-width ">
                                            ...
                                            `
                childElement.querySelector('.mdl-textfield__input').value = valueInput
