								...
								<div class="card-body row">
									...
									<div class="col-lg-6 p-t-20">
										<div
											class="mdl-textfield mdl-js-textfield mdl-textfield--floating-label txt-full-width">
											<input class="mdl-textfield__input" type="text"
												pattern="-?[0-9]*(\.[0-9]+)?" id="text8" name="phone_number" value="{{old('phone_number') ? old('phone_number') : '0'.$room->phone }}">
										...
										<div class="col-lg-6">
											<div class="mdl-textfield mdl-js-textfield mdl-textfield--floating-label txt-full-width"
												...
												<select name="status" class="mdl-textfield__input " id="txtConfirmPwd">
													...
													<option class="form-control form-control-sm px-2" value="2" {{$room->status == 2 ? 'selected':''}}>Bảo trì</option>
												</select>
									...
									<div class="col-lg-12 ">
										<div
											...
											<div class="image-preview pt-3">
												<img src="{{asset('storage/room/feature-image/'.$room->feature_image)}}" id="img-preview" alt="ảnh đại diện" width="50%" >
											</div>
										</div>
									</div>
