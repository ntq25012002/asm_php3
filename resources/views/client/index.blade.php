...
<section class="banner">
    ...
    <div class="banner-form">
        <div class="container">
            <form action="{{route('room-list')}}" method="get" class="form-content">
                ...
                <div class="table-item">
                    ...
                    <div class="form-group">
                        <div class="date-range-inner-wrapper">
                            <input id="date-range3" name="checkout" class="form-control" placeholder="yyyy-mm-dd">
                            <span class="input-group-addon">
                                <i class="fa fa-calendar" aria-hidden="true"></i>
                            </span>
                        </div>
                ...
                <div class="table-item">
                    ...
                    <div class="form-group">
                        <select name="room_type" title="Loại phòng" class="selectpicker" data-width="100%">
                ...
                <div class="table-item">
                    <label>Giá</label>
                    <div class="form-group">
                        <select name="price" title="Giá" class="selectpicker" data-width="100%">
                            <option value="0" {{request()->price==0?'selected':''}}>Tất cả</option>
