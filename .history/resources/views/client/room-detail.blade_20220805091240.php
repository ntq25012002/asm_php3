...
<section class="breadcrumb-outer">
    <div class="container">
        ...
        <h2>Room Details With Sidebar</h2>
        <nav aria-label="breadcrumb">
            <ul class="breadcrumb">
                <li class="breadcrumb-item"><a href="#">Home</a></li>
                <li class="breadcrumb-item active" aria-current="page">Room Details 2</li>
            </ul>
        </nav>
        </div>
    </div>
        ...
        @foreach ($relateRooms as $item)
            <div class="col-md-4">
                ...
                <div class="col-md-6 col-sm-6 col-xs-6">
                    <i class="fa-solid fa-family"></i> {{$item->roomType->adults}} Người lớn - {{$item->roomType->adults}} Trẻ em
                </div>
                <div class="col-md-6 col-sm-6 col-xs-6">
                <i class="fa fa-wifi" aria-hidden="true"></i> Dịch vụ nah
                </div>
                </div>
                </div>
