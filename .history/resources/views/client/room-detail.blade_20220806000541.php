...
<section class="content reservation-main">
    <form action="{{route('check-calendar',['id' => $room->id])}}" method="post" >
        ...
        <div class="container">
            ...
            <button type="button" class="btn btn-orange btn-check">Kiểm tra</button>
...
@section('scripts')
    ...
    <script>
        $(document).on('click','.btn-check',function(e){
            ...
            let firstMonth = $('.last-date-selected').parent().parent().parent().parent().find('.month-name').html();

            console.log(firstDate+' '+firstMonth);
            ...
            // // const date = new Date(checkIn.attr('time')).toSOString();
