            ...
            <form action=""  class="row">
                    ...
                    <div class="table-item">
                        ...
                        <div class="form-group">
                            <div class="date-range-inner-wrapper">
                                <input id="date-range2" name="checkin" class="form-control" placeholder="yyyy-mm-dd" value="{{request()->checkin}}">
                ...
                <div class="col-md-3 col-sm-4 col-xs-4">
                    <div class="table-item">
                        ...
                        <div class="form-group">
                            <div class="date-range-inner-wrapper">
                                <input id="date-range3" name="checkout" class="form-control" placeholder="yyyy-mm-dd"  value="{{request()->checkout}}">
                                {{-- <span class="input-group-addon">
                                    <i class="fa fa-calendar" aria-hidden="true"></i>
                                </span> --}}
                            </div>
                ...
                <div class="col-md-2 col-sm-4 col-xs-4">
                    <div class="form-group table-item room-type">
                        <label>Loại phòng</label>
                        <select name="room_type" class="selectpicker" data-width="100%" title="Loại phòng">
                            <option value="0" {{empty(request()->room_type)?'selected':''}}>Tất cả</option>
                ...
                <div class="col-md-2 col-sm-4 col-xs-4">
                    <div class="form-group table-item price">
                        <label>Giá</label>
                        <select name="price" class="selectpicker" data-width="100%" title="Giá">
                            <option value="" {{empty(request()->price)?'selected':''}}>Tất cả</option>
                ...
                <div class="col-md-2 col-sm-4 col-xs-4">
                    <div class="table-item">
                        <div class="form-btn mar-top-35">
                            <button type="submit" class="btn-submit">Lọc phòng</button>
                        </div>
                    </div>
                </div>
            </form>
                        ...
                        <div class="col-md-4 col-sm-6 col-xs-6">
                            ...
                            <div class="room-content">
                                <div class="room-title">
                                    <h4>{{$room->roomType->name}}</h4> <span>{{$room->name}}</span>
                                    <p class="price-ft">
