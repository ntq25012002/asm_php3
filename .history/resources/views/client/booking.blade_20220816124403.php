        ...
        <div class="booking">
            <div class="row">
                ...
                <div class="personal-info mar-top-50">
                    ...
                    {{-- <form action="{{url('/momo_payment')}}" method="get">
                        @csrf
                        <input type="text" hidden name="room_id" id="" value="{{$room->id}}">
                        <input type="text" hidden name="total" value="{{$roomBooking['nights'] * $room->price}}">
                        <button type="submit" class="btn btn-orange btn-confirm-booking" name="payUrl">Thanh toán MOMO</button>
                    </form> --}}
                </div>
