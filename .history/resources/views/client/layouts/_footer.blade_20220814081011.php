<footer>
    ...
    <div class="footer-payment">
        <h4>We Accept</h4>
        <ul>
            <li><img src="{{asset('client/images/icons/visa.png')}}" alt="image"></li>
            <li><img src="{{asset('client/images/icons/mastercard.png')}}" alt="image"></li>
            <li><img src="{{asset('client/images/icons/americanexpress.png')}}" alt="image"></li>
        </ul>
    </div>
    </div>
    <div class="col-md-3 col-sm-6 col-xs-12">
    ...
    <li>Email: <a href="https://htmldesigntemplates.com/cdn-cgi/l/email-protection" class="__cf_email__" data-cfemail="7c15121a133c3b1d09081d111d521f131152120c">[email&#160;protected]</a></li>
    ...
    <p class="white">Copyright 2020. Made with <span><a href="https://cyclonethemes.com/">Cyclone Themes</a></span>. All Rights Reserved. <a href="#">Gautama</a></p>
    <ul>
