<footer>
    ...
    <div class="footer-payment">
        <h4>We Accept</h4>
        <ul>
            <li><img src="{{asset('client/images/visa.png')}}" alt="image"></li>
            <li><img src="{{asset('client/images/mastercard.png')}}" alt="image"></li>
            <li><img src="{{asset('client/images/americanexpress.png')}}" alt="image"></li>
        </ul>
    </div>
    </div>
    <div class="col-md-3 col-sm-6 col-xs-12">
