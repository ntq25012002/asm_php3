<header class="main_header_area">
    ...
    <img alt="logo1" src="{{asset('client/images/logo.png')}}" class="logo-black">
    </a>
    </div>
    ...
    <li class="dropdown  active">
        <a href="{{route('home')}}" class="dropdown-toggle"  role="button" aria-haspopup="true" aria-expanded="false">Trang chủ</a>
    </li>
    <li class=" dropdown">
    ...
    <li class="submenu dropdown">
        ...
        <ul class="dropdown-menu">
            @foreach ($roomTypes as $type)
                <li><a href="{{route('list-room-type',$type->id)}}">{{$type->name}}</a></li>
            @endforeach
        </ul>
    </li>
    <li class="submenu dropdown">
    ...
    <a href="{{route('cart')}}" class="mt_cart"><i class="fa fa-shopping-cart"></i><span class="number-cart">0</span></a>
    </li>
    </ul>
    <div class="nav-btn">
