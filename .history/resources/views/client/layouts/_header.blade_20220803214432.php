<header class="main_header_area">
    ...
    <li class="submenu dropdown">
        <a href="restaurant.html" class="dropdown-toggle" data-toggle="dropdown" role="button" aria-haspopup="true" aria-expanded="false">Liên hệ<i class="fa fa-angle-down" aria-hidden="true"></i></a>
    </li>
