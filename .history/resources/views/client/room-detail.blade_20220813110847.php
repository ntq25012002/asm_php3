    ...
    {{-- <form action="{{route('check-calendar',['id' => $room->id])}}" method="post" id="form-calendar"> --}}
        ...
        <div class="container">
            ...
            <div class="d-flex justify-content-end">
                <a href="{{route('booking',['id'=> $room->id])}}"  data-url="{{route('booking',['id' => $room->id])}}" class="btn btn-orange btn-check pull-right" >Đặt phòng</a>
            </div>
                ...
                $.ajax({
                    ...
                    error: function (res) {
                        ...
                        if(res.code === 500) {
                            ...
                            Swal.fire('Phòng đã có người đặt trong khoảng thời gian này! Vui lòng chọn khoảng thời gian khác!')
                        }
                    }
                })
