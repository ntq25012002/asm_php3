...
@section('scripts')
    ...
    <script>
        ...
        btnCheck.onclick = function(e) {
            e.preventDefault();
            // let firstDate = document.querySelector('.first-date-selected').innerHTML;
            // let firstMonth = document.querySelector('.first-month-selected').parentElement.parentElement.parentElement.parentElement.querySelector('.month-name').innerHTML;
            ...
            // let firstDate = document.querySelector('.last-date-selected').innerHTML;
            // let firstMonth = document.querySelector('.last-date-selected').parentElement.parentElement.parentElement.parentElement.querySelector('.month-name').innerHTML;
