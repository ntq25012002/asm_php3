    ...
    <div class="container">
        <div class="booking">
            <div class="row">
                ...
                <p>{{$checkin['tm_mon']}}/{{$checkin['tm_year'] + 1900}}<br>{{$checkin['tm_wday'] == 0? 'Chủ nhật':'Thứ '.$checkin['tm_wday']+1}}</p>
                </div>
                <div class="rd-box">
                <label>Check out</label>
                <p class="bold">{{$checkout['tm_mday']}}</p>
                <p>{{$checkout['tm_mon']}}/{{$checkout['tm_year'] + 1900}}<br>{{$checkout['tm_wday']+1 == 8? 'Chủ nhật':'Thứ '.$checkout['tm_wday']+1}}</p>
                </div>
                </div>
                <div class="rd-top">
                <div class="rd-box">
