    ...
    <form action="{{route('check-calendar',['id' => $room->id])}}" method="post" id="form-calendar">
        ...
        <div class="container">
            ...
            <div class="d-flex justify-content-end">
                <button type="submit" class="btn btn-orange btn-check pull-right" >Đặt phòng</button>
            </div>
    ...
    <script>
        $(document).ready(function() {
            ...
            $(document).on('click', '.btn-check', function(e) {
                    ...
                    $('#checkin').val(checkin.getFullYear() + '-' + Number(checkin.getMonth())+1 + '-'+checkin.getDate())
                    $('#checkout').val(checkout.getFullYear() + '-' + Number(checkout.getMonth())+1 + '-'+checkout.getDate())
                    ...
                    //     const month = String(Number(a.getMonth()) + 1);
                    //     $('#checkin').val(a.getFullYear() + '-' + month + '-'+a.getDate())
                    ...
                    //     const month = String(Number(a.getMonth()) + 1);
                    //     $('#checkout').val(a.getFullYear() + '-' + month + '-'+a.getDate())
