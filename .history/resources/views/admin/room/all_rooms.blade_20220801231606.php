                        ...
                        <div class="row">
                            <div class="col-sm-12 col-md-6">
                                <div class="d-flex">
                                    ...
                                    <select name="" id="room_type_id" onChange="select1()" data-url="{{route('room.search')}}" class="form-select px-3 mx-2" style=" width: 210px;">
                                    ...
                                    <select name="" id="status" data-url="{{route('room.search')}}" class="form-select px-3 mx-2" style=" width: 180px;">
                                        <option value="">Trạng thái</option>
                            ...
                            <div class="col-sm-12 col-md-6">
                                <div class="d-flex d-inline-flex pull-right">
                                    ...
                                    <input type="text" name="search" id="keyword" data-url="{{route('room.search')}}"
...
<script>
    // let select1 = document.querySelector('#room_type_id');
    function a() {
        console.log('rooms');
    }
