							...
							<div class="card-head">
								...
								<div class="card-body row">
									...
									<div class="col-lg-6 p-t-20 ">
										...
										<div class="col-lg-6">
											<div class="d-flex">
												<input type="radio" name="status" value="1" id="action"><label for="action">Hoạt động</label>
												<input type="radio" name="status" value="0" id="maintain"><label for="maintain">Bảo trì</label>
											</div>
										</div>
									</div>
