                        ...
                        <div class="row">
                            <div class="col-sm-12 col-md-6">
                                <div class="d-flex">
                                    ...
                                    <select name="room_type_id" id="room_type_id" data-url="{{route('room.search')}}" class="form-select px-3 mx-2" style=" width: 210px;">
                                    ...
                                    <select name="status" id="status" data-url="{{route('room.search')}}" class="form-select px-3 mx-2" style=" width: 180px;">
                                        <option value="">Trạng thái</option>
