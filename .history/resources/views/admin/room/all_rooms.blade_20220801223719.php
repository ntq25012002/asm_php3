                        ...
                        <div class="row">
                            <div class="col-sm-12 col-md-6">
                                <div class="d-flex">
                                    ...
                                    <select name="" id="show_room_type" data-url="{{route('room.search')}}" class="form-select px-3 mx-2" style=" width: 210px;">
                                    ...
                                    <select name="status" data-url="{{route('room.search')}}" class="form-select px-3 mx-2" style=" width: 180px;">
                                        <option value="">Trạng thái</option>
