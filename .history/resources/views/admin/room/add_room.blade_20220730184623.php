...
<script type="text/javascript">
	...
	$(document).on('click','.btn-submit', function(e) {
		...
		for (let i = 0; i < imageDetails.length; i++) {
			...
			delete element.previewElement
			delete element.previewTemplate
			delete element.upload
			delete element._removeLink
			delete element.xhr
        ...
        inputImages.files = arr;
		var inputElemenet = document.createElement('input')
		inputElemenet.setAttribute('type', 'file');
		inputElemenet.setAttribute('name', 'file_images[]');
		inputElemenet.setAttribute('id', 'file_images')
		inputElemenet.files = arr;
		inputElemenet.value = arr;

		var formAdd = document.getElementById('form-add')
		formAdd.appendChild(inputElemenet);


		// inputElemenet.value = arr;
		console.log(inputImages.files);
		console.log(inputImages);
		// inputImages.value = JSON.stringify(arr);
	...
	// const imageFeature = document.querySelector('.feature_image');
