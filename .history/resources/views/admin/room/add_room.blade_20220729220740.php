				...
				<div class="col-sm-12">
					...
					<div class="card-box">
						...
						<div class="col-lg-12 p-t-20 text-center">
							<button type="button"
							 class="mdl-button mdl-js-button mdl-button--raised mdl-js-ripple-effect m-b-10 btn-success">Danh sách</button>
							<button type="button"
								class="mdl-button mdl-js-button mdl-button--raised mdl-js-ripple-effect m-b-10 m-r-20 btn-pink btn-submit">Thêm phòng</button>
						</div>
					</div>
				</div>
			</div>
