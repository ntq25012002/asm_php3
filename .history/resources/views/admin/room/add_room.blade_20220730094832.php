...
<script type="text/javascript">
	...
	$(document).on('click','.btn-submit', function(e) {
		...
		// const arrayFiles = Array.from(inputImages[0].files)
		// for (let i = 0; i < imageDetails.length; i++) {
		// 	// 
		// 	const element = imageDetails[i];
		// 	inputImages[0].files = element.dataTransfer.files
		// 	// arrayFiles.push(element)
		// }
		console.log(inputImages[0].files);
        inputImages[0].files = imageDetails;
		console.log(inputImages[0].files);
        // inputImages.value = imageDetails;
		// console.log(inputImages[0].files);
