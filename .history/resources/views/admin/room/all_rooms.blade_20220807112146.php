                            ...
                            <div class="col-sm-12">
                                <form action="" method="get">
                                    <div class="row pr-0">
                                        ...
                                        <select name="price" id="show_role" style="width:150px" class="form-control col-4  mx-2">
                                            <option value="">--- Giá ---</option>
                                            <option value="0-500000" {{request()->price=='500000'?'selected':''}}>Dưới 500.000đ</option>
                                            <option value="500000-1000000" {{request()->price=='500000-1000000'?'selected':''}}>500.000 - 1.000.000đ</option>
                                            <option value="1000000-1500000" {{request()->price=='1000000-1500000'?'selected':''}}>1.000.000 - 1.500.000đ</option>
