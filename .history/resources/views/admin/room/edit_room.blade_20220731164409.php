									...
									<div class="col-lg-12 ">
										<div
											...
											<div class="image-preview pt-3">
												<img src="{{asset('storage/room/feature-image/'.$room->feature_image)}}" id="img-preview" alt="" >
											</div>
										</div>
									</div>
					...
					<div class="card-box">
						...
						<div class="card-body now">
							<div class="col-lg-12 p-t-20">
								...
								<input type="text" id="images-old" class="form-control" data-filepath = "{{asset('storage/room/feature-image/'.$room->feature_image)}}" value="{{$room->images}}">
