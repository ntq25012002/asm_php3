				...
				<div class="col-sm-12">
								...
								<div class="card-body row">
									...
									<div class="col-lg-12 ">
										<div
											...
											<input class="mdl-textfield__input" name="feature_image" type="file" id="dateOfBirth">
										</div>
									</div>
								</div>
					...
					<div class="card-box">
						...
						<div class="col-lg-12 p-t-20 text-center">
							<button type="button"
							 class="mdl-button mdl-js-button mdl-button--raised mdl-js-ripple-effect m-r-20 m-b-10 btn-success">Danh sách</button>
							<button type="button"
								class="mdl-button mdl-js-button mdl-button--raised mdl-js-ripple-effect m-b-10 btn-pink btn-submit">Thêm phòng</button>
						</div>
					</div>
				</div>
			</div>
