                        ...
                        <div class="row">
                            <div class="col-sm-12 col-md-6">
                                <div class="d-flex">
                                    ...
                                    <select name="" id="show_room_type" data-url="{{route('room.search')}}" class="form-select px-3 mx-2" aria-label="Default select example">
                                    ...
                                    <select name="status" data-url="{{route('room.search')}}" class="form-select px-3 mx-2">
                                        <option value="">Trạng thái</option>
