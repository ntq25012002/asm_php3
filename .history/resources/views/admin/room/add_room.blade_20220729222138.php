								...
								<div class="card-body row">
									...
									<div class="col-lg-12 ">
										<div
											...
											<input class="mdl-textfield__input" id="fileFeatureImage" name="feature_image" type="file" id="dateOfBirth">
											<div class="image-preview">
												<img src="" id="img-preview" alt="a" >
											</div>
										</div>
									</div>
								</div>
...
<script type="text/javascript">
	...
	const img = document.getElementById('fileFeatureImage');
