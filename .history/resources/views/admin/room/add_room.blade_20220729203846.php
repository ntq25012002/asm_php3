...
{{-- <script type="text/javascript">
	...
	$(document).on('click','#dropzone',function(e) {
		var dataFileName = document.querySelectorAll('.dz-filename').innerText;
		console.log(document.querySelectorAll('.dz-filename'));
	})
