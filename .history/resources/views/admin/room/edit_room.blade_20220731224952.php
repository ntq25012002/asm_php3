										...
										<div class="col-lg-6">
											<div class="mdl-textfield mdl-js-textfield mdl-textfield--floating-label txt-full-width"
												...
												<select name="status" class="mdl-textfield__input " id="txtConfirmPwd">
													{{-- <option value=""></option> --}}
													<option class="form-control form-control-sm px-2" {{$room->status == 1 ? 'selected'}} value="1">Hoạt động</option>
													<option class="form-control form-control-sm px-2"  {{$room->status == 0 ? 'selected'}} value="0">Bảo trì</option>
												</select>
