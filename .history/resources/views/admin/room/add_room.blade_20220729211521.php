					...
					<div class="card-box">
						...
						<div class="card-body row">
							...
							<div class="col-lg-12 p-t-20">
								...
								{{-- <form method="post" action="{{route('room.store-file')}}" enctype="multipart/form-data" 
...
<script type="text/javascript">
	...
	$(document).on('click','.btn-submit', function(e) {
		...
		if(dropzone) {
			let dataInputFileImage = document.createElement('input');
			dataInputFileImage.attributes['name'] = 'dataImages[]';
			dataInputFileImage.attributes['value'] = arr;
			dropzone.appendChild(dataInputFileImage);
			console.log(dataInputFileImage.value);
		}
	})
</script>
