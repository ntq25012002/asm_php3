							...
							<div class="card-body row">
								<div class="col-lg-6 p-t-20">
									<div
										...
										<input class="mdl-textfield__input" type="text" id="txtRoomNo" name="name" value="{{old('name')}}">
								...
								<div class="col-lg-6 p-t-20">
									<div
										class="mdl-textfield mdl-js-textfield mdl-textfield--floating-label txt-full-width">
										<input class="mdl-textfield__input" type="text" id="txtRoomNo" name="area" value="{{old('area')}}">
								...
								<div class="col-lg-6 p-t-20">
									<div
										...
										<input class="mdl-textfield__input" type="text"
											pattern="-?[0-9]*(\.[0-9]+)?" id="text7" name="price" value="{{old('price')}}">
								...
								<div class="col-lg-6 p-t-20">
									<div
										class="mdl-textfield mdl-js-textfield mdl-textfield--floating-label txt-full-width">
										<input class="mdl-textfield__input" type="text"
											pattern="-?[0-9]*(\.[0-9]+)?" id="text8" name="phone_number" value="{{old('phone_number')}}">
									...
									<div class="col-lg-6">
										<div class="mdl-textfield mdl-js-textfield mdl-textfield--floating-label txt-full-width"
											...
											<select name="air_condition" class="mdl-textfield__input " id="txtConfirmPwd">
												...
												<option class="form-control form-control-sm px-2" selected value="0">Không</option>
											</select>
									...
									<div class="col-lg-6">
										<div class="mdl-textfield mdl-js-textfield mdl-textfield--floating-label txt-full-width"
											...
											<select name="status" class="mdl-textfield__input " id="txtConfirmPwd">
												{{-- <option value=""></option> --}}
												<option class="form-control form-control-sm px-2" selected value="1">Hoạt động</option>
												<option class="form-control form-control-sm px-2" value="2">Bảo trì</option>
											</select>
								...
								<div class="col-lg-12 ">
									<div
										...
										<input class="mdl-textfield__input" id="fileFeatureImage" name="feature_image" type="file"  onchange="previewImage()">
										@error('feature_image')
											<span style="color: tomato">
												{{$message}}
											</span>
										...
										<div class="image-preview pt-3">
											<img src="" id="img-preview" alt="" width="50%">
										</div>
									</div>
								</div>
								<input type="text" id="images-old" name="data_image" class="form-control" value="" hidden>
					...
					<div class="card-box">
						...
						<div class="col-lg-12 p-t-20 text-center">
							<a href="{{route('room.index')}}"
							 class="mdl-button mdl-js-button mdl-button--raised mdl-js-ripple-effect m-r-20 m-b-20 btn-success">Danh sách</a>
							<button type="button"
