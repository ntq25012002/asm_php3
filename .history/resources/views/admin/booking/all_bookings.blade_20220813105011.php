    ...
    <div class="page-content">
        <div class="page-bar">
            <div class="page-title-breadcrumb">
                <div class=" pull-left">
                    <div class="page-title">Danh sách đơn đặt phòng</div>
                </div>
                <ol class="breadcrumb page-breadcrumb pull-right">
                    <li><i class="fa fa-home"></i>&nbsp;<a class="parent-item" href="index.html">Home</a>&nbsp;<i
                            class="fa fa-angle-right"></i>
                    </li>
                    <li class="active">Danh sách đơn đặt phòng</li>
                </ol>
            </div>
        </div>
        <div class="row">
            <div class="col-md-12">
                ...
                <div class="card card-box">
                    <div class="card-head">
                        <header>Danh sách các đơn đặt phòng</header>
                        <div class="tools">
                                ...
                                <form action="" method="get">
                                    <div class="row pr-0">
                                        ...
                                        <div class="col-2 px-0">
                                            <input type="date" name="checkin" id="checkin" placeholder="dd/mm/yyyy"
                                    ...
                                    @if(count($bookings) > 0)
                                        @foreach ($bookings as $booking)
                                            <tr class="odd gradeX">
                                                ...
                                                <td class="center">{{date('d/m/Y', strtotime($booking->checkin))}}  </td>
                                                <td class="center">{{date('d/m/Y', strtotime($booking->checkout))}} </td>
