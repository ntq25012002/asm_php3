                        ...
                        <form action="{{ route('booking.update') }}" method="post" enctype="multipart/form-data">
                            ...
                            <div class="card-body row">
                                ...
                                <div class="col-lg-12 ">
                                    ...
                                    <div class="pb-3">
                                        Trạng thái:
                                        <input type="radio" name="payment" class="px-1" value="2" id="unpaid" {{$booking->payment == 2? 'checked':''}}><label for="unpaid">Chưa thanh toán </label> 
                                        <input type="radio" name="payment" class="px-1" value="1" id="paid" {{$booking->payment == 1? 'checked':''}}><label for="paid">Đã thanh toán </label> 
                                    </div>
                                    <div class="pb-3">
