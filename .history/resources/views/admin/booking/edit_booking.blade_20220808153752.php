                        ...
                        <div class="card-head">
                            ...
                            <div class="card-body row">
                                ...
                                <div class="col-lg-12 ">
                                    ...
                                    <div class="pb-3">
                                        Số điện thoại: 0{{$booking->customer->phone}}
                                    </div>
                                    <div class="pb-3">
                                ...
                                <div class="col-lg-12 ">
                                    ...
                                    <div>
                                        ...
                                        {{-- @if ($booking->payment == 2) --}}
                                            <input type="radio" name="payment" value="2" id="unpaid" {{$booking->payment == 2? 'checked':''}}><label for="unpaid">Chưa thanh toán </label> 
                                        {{-- @else --}}
                                        <input type="radio" name="payment" value="1" id="paid" {{$booking->payment == 1? 'checked':''}}><label for="paid">Đã thanh toán </label> 
                                        {{-- @endif --}}
                                    </div>
                                    <div>
