                                    ...
                                    @if(count($bookings) > 0)
                                        @foreach ($bookings as $booking)
                                            <tr class="odd gradeX">
                                                ...
                                                <td class="center">{{$booking->rooms}}</td>
                                                <td class="center">{{$booking->checkin}}  </td>
                                                <td class="center">{{$booking->checkout}}</td>
                                                ...
                                                <td class="center">
                                                    <a href="{{route('booking.edit',['id' => $room->id])}}" class="btn btn-tbl-edit btn-xs">
                                                        <i class="fa fa-pencil"></i>
                                                    </a>
                                                    <a class="btn btn-tbl-delete btn-xs btn-delete" data-url="{{route('booking.delete',['id' => $room->id])}}" data-name="{{$room->name}}">
                                                        <i class="fa fa-trash-o "></i>
                                                    </a>
                                                </td>
                                            </tr>
                                        @endforeach
                                        <a href="#" data-url="{{route('room.delete-bookings')}}" class="text-danger delete_btn">Xóa mục đã chọn</a>
