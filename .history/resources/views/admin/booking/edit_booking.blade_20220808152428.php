                        ...
                        <form action="{{ route('booking.update') }}" method="post" enctype="multipart/form-data">
                            ...
                            <div class="card-body row">
                                ...
                                <div class="col-lg-6 ">
                                    ...
                                    <div>
                                        Số điện thoại: {{$booking->customer->address}}
                                    </div>
                                    <div>
                                        Thời gian đặt: {{$booking->customer->created_at}}
                                    </div>
                                </div>
                                <div class="col-lg-6 ">
                                    <div>
                                    ...
                                    <div>
                                        @if ($booking->payment == 2)
                                            <span class="btn btn-sm btn-default">Chưa thanh toán <a>sửa</a> </span> 
                                        @else
                                            <span class="btn btn-sm btn-success">Đã thanh toán <a>sửa</a> </span>
                                        @endif
                                    </div>
                                </div>
