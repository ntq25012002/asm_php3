                                            ...
                                            @if (count($sliders) > 0)
                                                @foreach ($sliders as $silder)
                                                    <tr class="odd gradeX">
                                                        ...
                                                        <td class="center">
                                                            <a href="{{ route('sliders.edit', ['id' => $silder->id]) }}"
                                                                class="btn btn-tbl-edit btn-xs">
                                                                <i class="fa fa-pencil"></i>
                                                            </a>
                                                            <a href="{{route('sliders.delete',['id' => $silder->id])}}" data-url="{{route('sliders.delete',['id'=>$silder->id])}}" data-title_silder = "{{$silder->title}}" class="btn btn-tbl-delete btn-xs btn-delete">
