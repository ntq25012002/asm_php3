                                                ...
                                                @foreach ($sliders as $slider)
                                                    <tr class="odd gradeX">
                                                        ...
                                                        <td class="center">
                                                            ...
                                                            <a href="#" data-url="{{route('slider.delete', ['id' => $slider->id])}}" data-name = "{{$slider->title}}" class="btn btn-tbl-delete btn-xs btn-delete">
                                                                <i class="fa fa-trash-o "></i>
                                                            </a>
                                                        </td>
                                                    </tr>
                                                @endforeach
                                                <a href="#" data-url="{{route('slider.delete-sliders')}}" class="text-danger delete_btn">Xóa mục đã chọn</a>
