                                        ...
                                        <tbody id="list_slider">
                                            @if (count($sliders) > 0)
                                                @foreach ($sliders as $slider)
                                                    <tr class="odd gradeX">
                                                        <td>
                                                            <input type="checkbox" name="slider{{$slider->id}}" >
                                                        </td>
                                                        <td class="" >
                                                        ...
                                                        <td class="center">
                                                            ...
                                                            <a href="{{route('slider.delete', ['id' => $slider->id])}}" data-url="{{route('slider.delete', ['id' => $slider->id])}}" data-title_silder = "{{$slider->title}}" class="btn btn-tbl-delete btn-xs btn-delete">
