                                                ...
                                                @if (count($sliders) > 0)
                                                    @foreach ($sliders as $silder)
                                                        <tr class="odd gradeX">
                                                            ...
                                                            <td class="center">
                                                                <a href="{{ route('silder.edit', ['id' => $silder->id]) }}"
                                                                    class="btn btn-tbl-edit btn-xs">
                                                                    <i class="fa fa-pencil"></i>
                                                                </a>
                                                                <a href="{{route('silder.delete',['id' => $silder->id])}}" data-url="{{route('silder.delete',['id'=>$silder->id])}}" data-title_silder = "{{$silder->title}}" class="btn btn-tbl-delete btn-xs btn-delete">
