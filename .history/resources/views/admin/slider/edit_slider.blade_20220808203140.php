        ...
        <div class="page-content">
            <div class="page-bar">
                <div class="page-title-breadcrumb">
                    <div class=" pull-left">
                        <div class="page-title">Thêm Slide</div>
                    </div>
                    <ol class="breadcrumb page-breadcrumb pull-right">
                        <li><i class="fa fa-home"></i>&nbsp;<a class="parent-item" href="index.html">Home</a>&nbsp;<i
                                class="fa fa-angle-right"></i>
                        </li>
                        <li><a class="parent-item" href="#">Slide</a>&nbsp;<i class="fa fa-angle-right"></i>
                        </li>
                            ...
                            <div class="card-body row">
                                <div class="col-lg-12 p-t-20">
                                    <div
                                        ...
                                        <input class="mdl-textfield__input" name="title" type="text" id="txtFirstName" value="{{old('title') ?? $slider->title}}">
                                ...
                                <div class="col-lg-12 p-t-20">
                                    ...
                                    <div class="image-preview pt-3">
										<img src="{{$slider->image}}" id="img-preview" alt="" width="50%">
									</div>
                                </div>
                                <div class="col-lg-12 p-t-20">
                                    <div class="mdl-textfield mdl-js-textfield txt-full-width">
                                        <textarea class="mdl-textfield__input" rows="4" id="text7" name="description">{{old('desciption') ?? $slider->description}}</textarea>
