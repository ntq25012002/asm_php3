                            ...
                            <form action="" method="post">
                                ...
                                <div class="row">
                                    <div class="col-sm-12 col-md-6">
                                        <div class="d-flex px-0 d-inline-flex">
                                            {{-- <label for="" class="pt-1">Show:</label> --}}
                                            <select name="" id="show_role" data-url="{{route('staff.search')}}" style="width:140px" class="form-control px-3 mx-2">
                                            ...
                                            <div class="d-flex ">
                                                <input type="text" name="search" id="keyword" data-url="{{route('staff.search')}}"
                                                    class="form-control form-control-sm " placeholder="Nhập tên">
                                            </div>
                                            <div>
