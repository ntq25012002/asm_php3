                        ...
                        <form action="{{ route('staff.store') }}" method="post" enctype="multipart/form-data">
                            ...
                            <div class="card-body row">
                                ...
                                <div class="col-lg-6 ">
                                    <div
                                        class="mdl-textfield mdl-js-textfield mdl-textfield--floating-label txt-full-width">
                                        <input class="mdl-textfield__input" name="password" type="password" id="txtPwd"  value="{{old('password')}}">
                                ...
                                <div class="col-lg-6 ">
                                    <div
                                        class="mdl-textfield mdl-js-textfield mdl-textfield--floating-label txt-full-width">
                                        <input class="mdl-textfield__input" name="password_confirmation" type="password" id="txtConfirmPwd"  value="{{old('password_confirmation')}}">
                                    ...
                                    <div class="mdl-textfield mdl-js-textfield mdl-textfield--floating-label txt-full-width"
                                        ...
                                        <select name="role_id" class="mdl-textfield__input " id="txtConfirmPwd">
                                            ...
                                            @foreach ($roles as $role)
                                                <option class="form-control form-control-sm px-2" {{old('role_id') == $role->role_id ? 'selected' : ''}}
