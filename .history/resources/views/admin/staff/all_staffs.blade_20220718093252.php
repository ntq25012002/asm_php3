                                    ...
                                    <div class="row">
                                        <div class="col-sm-12 col-md-6">
                                            <div class="d-flex d-inline-flex">
                                                <label for="" class="pt-1">Hiển thị:</label>
                                        ...
                                        <div class="col-sm-12 col-md-6">
                                            <div class="d-flex d-inline-flex pull-right">
                                                <label for="" class="px-2 pt-1">Tìm kiếm:</label>
                                            ...
                                            <thead>
                                                <tr>
                                                    ...
                                                    <th class="center" data-sort_by="name" data-sort_type="desc" data-url="{{route('search')}}" id="name"> 
                                                        Họ tên 
                                                        {{-- <i class="fa  fa-sort-alpha-asc sort-icon active"></i>
                                                        <i class="fa  fa-sort-alpha-desc sort-icon"></i> --}}
                                                    </th>
                                                ...
                                                @foreach ($staffs as $staff)
                                                    <tr class="odd gradeX">
                                                        ...
                                                        <td class="center">
                                                            ...
                                                            <a data-url="{{route('staff.delete',['id'=>$staff->id])}}" class="btn btn-tbl-delete btn-xs btn-delete">
