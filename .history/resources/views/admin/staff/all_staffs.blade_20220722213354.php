                                        ...
                                        <table class="table table-hover table-checkable order-column full-width"
                                            ...
                                            <thead>
                                                <tr>
                                                    ...
                                                    <th class="center" data-sort_by="created_at" data-sort_type="asc" data-url="{{route('search')}}" id="joining_date"> 
                                                        Ngày tham gia 
                                                        <span>
                                                ...
                                                <form action="{{route('staff.delete-staffs')}}" method="get">
                                                    @if (count($staffs) > 0)
                                                        @foreach ($staffs as $staff)
                                                            <tr class="odd gradeX">
                                                                <td>
                                                                    <input type="checkbox" name="staffId[]" value="{{$staff->id}}" >
                                                                </td>
                                                                ...
                                                                <td class="center">
                                                                    ...
                                                                    <a  data-name_staff = "{{$staff->name}}" class="btn btn-tbl-delete btn-xs btn-delete">
