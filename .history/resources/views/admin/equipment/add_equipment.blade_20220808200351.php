        ...
        <div class="page-content">
            <div class="page-bar">
                <div class="page-title-breadcrumb">
                    <div class=" pull-left">
                        <div class="page-title">Thêm thiết bị</div>
                    </div>
                            ...
                            <div class="card-body row">
                                ...
                                <div class="col-lg-12 p-t-20">
                                    <div class="mdl-textfield mdl-js-textfield txt-full-width">
                                        <textarea class="mdl-textfield__input" rows="4" id="text7" name="description">{{old('description')}}</textarea>
                                ...
                                <div class="col-lg-12 p-t-20">
                                    <div
                                        ...
                                        <input class="mdl-textfield__input" name="image" type="file" id="fileFeatureImage">
                                    </div>
                                    @error('image')
                                        <span style="color: tomato">
                                            {{ $message }}
