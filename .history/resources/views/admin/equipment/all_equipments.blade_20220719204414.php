                                ...
                                <div class="card-body ">
                                    <div class="row p-b-20 ">
                                        <div class="col-md-6 col-sm-6 col-6">
                                            <div class="btn-group">
                                                <a href="{{ route('equipment.create') }}" class="btn btn-info">Thêm dịch vụ<i
                                        ...
                                        <table class="table table-hover table-checkable order-column full-width"
                                            ...
                                            <thead>
                                                <tr>
                                                    ...
                                                    <th  style="width:20%; border-radius: 0">Ảnh</th>
                                            ...
                                            <tbody id="list_service">
                                                @foreach ($equipments as $equipment)
                                                    <tr class="odd gradeX">
                                                        <td>
                                                            <input type="checkbox" name="staff{{$equipment->id}}" >
                                                        </td>
                                                        <td class="user-circle-img sorting_1" style="border-radius: 0">
                                                            <img src="{{ asset($equipment->image) }}" alt="" width="100%" border-radius="0">
                                                        </td>
                                                        ...
                                                        <td class="center">
                                                            ...
                                                            <a data-url="{{route('equipment.delete',['id'=>$equipment->id])}}" data-name_staff = "{{$equipment->name}}" class="btn btn-tbl-delete btn-xs btn-delete">
