            ...
            <div class="row">
                <div class="col-sm-12">
                    <div class="card-box">
                        ...
                        <form action="{{ route('staff.update',['id' => $service->id]) }}" method="post" enctype="multipart/form-data">
							@csrf
                            <div class="card-body row">
                                ...
                                <div class="col-lg-6 p-t-20">
                                    <div
                                        ...
                                        <input class="mdl-textfield__input" name="name" type="text" id="txtFirstName" value="{{old('name') }}">
