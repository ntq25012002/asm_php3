                                ...
                                <div class="card-body ">
                                    <div class="row p-b-20 ">
                                        <div class="col-md-6 col-sm-6 col-6">
                                            <div class="btn-group">
                                                <a href="{{ route('equipment.create') }}" class="btn btn-info">Thêm thiết bị<i
                                                    ...
                                                    @foreach ($equipments as $equipment)
                                                        <tr class="odd gradeX">
                                                            ...
                                                            <td class="center">
                                                                ...
                                                                <a href="#" data-url="{{route('equipment.delete',['id'=>$equipment->id])}}" data-name = "{{$equipment->name}}" class="btn btn-tbl-delete btn-xs btn-delete">
                                                                    <i class="fa fa-trash-o "></i>
                                                                </a>
                                                            </td>
                                                        </tr>
                                                    @endforeach
                                                    <a href="#" data-url="{{route('equipment.delete-equipments')}}" class="text-danger delete_btn">Xóa mục đã chọn</a>
