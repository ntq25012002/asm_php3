                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-sm-12 col-md-6">
                                            <div class="d-flex d-inline-flex pull-right">
                                                ...
                                                <input type="text" name="search" id="keyword" data-url="{{route('equipment.search')}}"
                                        ...
                                        <table class="table table-hover table-checkable order-column full-width"
                                            ...
                                            <thead>
                                                <tr>
                                                    ...
                                                    <th class="center" data-sort_by="name" data-sort_type="desc" data-url="{{route('equipment.search')}}" id="name"> 
                                                        Thiết bị
                                                       <span>
