						...
						<form action="{{route('room-type.store')}}" method="post" enctype="multipart/form-data">
							<div class="card-body row">
								...
								{{-- <div class="col-lg-3 ">
									...
									<div class="col-lg-6">
										@foreach ($equipments as $equipment)
											<input class="form-control form-control-sm px-2" type="checkbox" id="equipment_{{$equipment->id}}" {{old('equipment_id') == $equipment->id ? 'checked' : ''}}
												value="{{ $equipment->id }}"/>
										...
										<div class="col-lg-6">
											<div
												class="mdl-textfield mdl-js-textfield mdl-textfield--floating-label txt-full-width">
												<input class="mdl-textfield__input" name="quantity_equipment" type="text" id="text8">
