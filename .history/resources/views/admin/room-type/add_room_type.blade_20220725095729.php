										...
										<div class="d-flex">
											...
											<div class="col-lg-10">
												<div class="mdl-textfield mdl-js-textfield mdl-textfield--floating-label txt-full-width ">
													<input class="mdl-textfield__input hidden" style="margin-left:12px" name="quantity_equipment_{{$equipment->id}}" type="text" id="text8">
													<label class="mdl-textfield__label hidden" style="margin-left:12px" for="text8">Số lượng {{strtolower($equipment->name)}}</label>
												</div>
											</div>
										</div>
									@endforeach
...
@section('scripts')
	...
	<script>
		$(document).ready(function() {
			$(document).on('toogle','.equipment',function() {
				const equipmentChecked = $('.equipment:checked');
				const main = $(this).toogle(function() {

				});
				// console.log($(this).parent());
				// if(main) {
				// 	const elementChild = document.createElement('div');
				// 	elementChild.classList.add('col-lg-10')
				// 	elementChild.innerHTML = `<div class="mdl-textfield mdl-js-textfield mdl-textfield--floating-label txt-full-width ">
				// 								<input class="mdl-textfield__input" style="margin-left:12px" name="quantity_equipment_{{$equipment->id}}" type="text" id="text8">
				// 								<label class="mdl-textfield__label" style="margin-left:12px" for="text8">Số lượng {{strtolower($equipment->name)}}</label>
				// 							</div>`
				// 							console.log(elementChild);
				// 	main.appendChild(elementChild)
				// }
			})
		})
	</script>
