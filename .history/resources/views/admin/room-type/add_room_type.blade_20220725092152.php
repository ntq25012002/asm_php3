							...
							<div class="card-body row">
								...
								<div class="col-lg-6 ">
									@foreach ($equipments as $equipment)
										<div class="d-flex">
											<div class="col-lg-3">
												<input class=""  type="checkbox" id="equipment_{{$equipment->id}}" {{old('equipment_id') == $equipment->id ? 'checked' : ''}}
													value="{{ $equipment->id }}"/>
												<label style="padding: 22px 0" for="equipment_{{$equipment->id}}">{{$equipment->name}}</label>
											</div>
											<div class="col-lg-9">
												<div
													class="mdl-textfield mdl-js-textfield mdl-textfield--floating-label txt-full-width">
