										...
										<div class="d-flex">
											...
											<div class="col-lg-10 quantity_equipment">
												<div class="mdl-textfield mdl-js-textfield mdl-textfield--floating-label txt-full-width ">
													<input class="mdl-textfield__input " style="margin:0 -12px 0 12px; outline:none" name="quantity_equipments[]" type="text" id="text8" value="{{$roomType->equipments[$i]->pivot->quantity_equipment }}">
