										...
										<div class="d-flex">
											...
											<div class="col-lg-10">
												<div class="mdl-textfield mdl-js-textfield mdl-textfield--floating-label txt-full-width ">
													<input class="mdl-textfield__input ml-2" name="quantity_equipment_{{$equipment->id}}" type="text" id="text8">
													<label class="mdl-textfield__label ml-2" for="text8">Số lượng {{strtolower($equipment->name)}}</label>
												</div>
											</div>
										</div>
									@endforeach
