										...
										<div class="d-flex">
											...
											<div class="col-lg-10 hidden quantity_equipment">
												<div class="mdl-textfield mdl-js-textfield mdl-textfield--floating-label txt-full-width ">
													<input class="mdl-textfield__input " style="margin:0 12px" name="quantity_equipment_{{$equipment->id}}" type="text" id="text8">
													<label class="mdl-textfield__label " style="margin:0 12px" for="text8">Số lượng {{strtolower($equipment->name)}}</label>
												</div>
											</div>
										</div>
									@endforeach
