                                            ...
                                            @foreach ($roomTypes as $item)
                                                <tr class="odd gradeX">
                                                    ...
                                                    <td class="center">
                                                        ...
                                                        <span>( {{$item->quantity_equipment}} ) </span>
                                                    </td>
                                                    <td class="center">{{$item->adults}}</td>
                                                    <td class="center">{{$item->children}}</td>
                                                    <td class="center">{{$item->description}}</td>
                                                    <td class="center">
                                                        <a href="{{route('room-type.edit',$item->id)}}" class="btn btn-tbl-edit btn-xs">
                                                            <i class="fa fa-pencil"></i>
                                                        </a>
                                                        <a href="{{route('room-type.delete',$item->id)}}" class="btn btn-tbl-delete btn-xs">
