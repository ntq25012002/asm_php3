							...
							<div class="card-body row">
								...
								<div class="col-lg-6 ">
									@foreach ($equipments as $equipment)
										<div class="d-flex">
											<div class="col-lg-2">
												<input type="checkbox" id="equipment_{{$equipment->id}}" {{old('equipment_id') == $equipment->id ? 'checked' : ''}}
													value="{{ $equipment->id }}"/>
												<label style="padding: 22px 0;color: #aaaaaa !important; font-size: 14px" for="equipment_{{$equipment->id}}">{{$equipment->name}}</label>
											</div>
											<div class="col-lg-10">
												<div class="mdl-textfield mdl-js-textfield mdl-textfield--floating-label txt-full-width px-2">
													<input class="mdl-textfield__input" name="quantity_equipment_{{$equipment->id}}" type="text" id="text8">
													<label class="mdl-textfield__label" for="text8">Số lượng {{strtolower($equipment->name)}}</label>
												</div>
											</div>
										</div>
									@endforeach
