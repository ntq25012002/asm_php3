										...
										<div class="d-flex">
											...
											<div class="col-lg-10 hidden quantity_equipment">
												<div class="mdl-textfield mdl-js-textfield mdl-textfield--floating-label txt-full-width ">
													<input class="mdl-textfield__input " style="margin:0 -12px 0 12px" name="quantity_equipment_{{$equipment->id}}" type="text" id="text8">
	...
	<script>
		$(document).ready(function() {
			$(document).on('change','.equipment',function() {
				...
				const isChecked = $(this).parent().parent().find('.quantity_equipment .hidden')
				if(isChecked) {
					// isChecked = false;
