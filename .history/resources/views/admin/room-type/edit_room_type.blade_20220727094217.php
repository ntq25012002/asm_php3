					...
					<div class="card-box">
						...
						<form action="{{route('room-type.update', ['id' => $roomType->id])}}" method="post" enctype="multipart/form-data">
							<div class="card-body row">
								...
								<div class="col-lg-6 ">
									{{$roomType->equipments->$equipment->id}}
										...
										<div class="d-flex">
											<div class="col-lg-2 " style="padding: 22px 0;color: #aaaaaa !important; font-size: 14px">
												<input type="checkbox" class="equipment" id="equipment_{{$equipment->id}}" {{old('equipment_id') == $equipment->id ? 'checked' : ''}}
													{{$roomType->equipments->contains($equipment->id) ? 'checked' : ''}}
											...
											<div class="col-lg-10 quantity_equipment">
												<div class="mdl-textfield mdl-js-textfield mdl-textfield--floating-label txt-full-width ">
													<input class="mdl-textfield__input " style="margin:0 -12px 0 12px; outline:none" name="quantity_equipments[]" type="text" id="text8" value="{{$roomType->equipments}}">
