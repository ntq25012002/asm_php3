                                        ...
                                        <table class="table table-hover table-checkable order-column full-width"
                                            ...
                                            <tbody id="list_service">
                                                @foreach ($services as $service)
                                                    <tr class="odd gradeX">
                                                        <td>
                                                            <input type="checkbox" name="staff{{$service->id}}" >
                                                        </td>
                                                        <td class="">
                                                        ...
                                                        <td class="center">
                                                            ...
                                                            <a data-url="{{route('service.delete',['id'=>$service->id])}}" data-name_staff = "{{$service->name}}" class="btn btn-tbl-delete btn-xs btn-delete">
