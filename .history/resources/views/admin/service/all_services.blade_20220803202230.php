                                                    ...
                                                    @foreach ($services as $service)
                                                        <tr class="odd gradeX">
                                                            ...
                                                            <td class="center">
                                                                ...
                                                                <a href="#" data-url="{{route('service.delete',['id'=>$service->id])}}" data-name = "{{$service->name}}" class="btn btn-tbl-delete btn-xs btn-delete">
                                                                    <i class="fa fa-trash-o "></i>
                                                                </a>
                                                            </td>
                                                        </tr>
                                                    @endforeach
                                                    <a href="#" data-url="{{route('service.delete-equipments')}}" class="text-danger delete_btn">Xóa mục đã chọn</a>
