        ...
        <div class="page-content">
            <div class="page-bar">
                <div class="page-title-breadcrumb">
                    <div class=" pull-left">
                        <div class="page-title">Sửa thông tin dịch vụ</div>
                    </div>
                    <ol class="breadcrumb page-breadcrumb pull-right">
                        ...
                        <li class="active">Sửa thông tin dịch vụ</li>
                    </ol>
                </div>
            </div>
            <div class="row">
                            ...
                            <div class="card-body row">
                                ...
                                <div class="col-lg-6 p-t-20">
                                    <div
                                        ...
                                        <input class="mdl-textfield__input" name="name" type="text" id="txtFirstName" value="{{old('name') ?? $service->name}}">
                                        <label class="mdl-textfield__label">Dịch vụ</label>
                                    </div>
                                </div>
                                <div class="col-lg-12 p-t-20">
                                    <div class="mdl-textfield mdl-js-textfield txt-full-width">
                                        <textarea class="mdl-textfield__input" rows="4" id="text7" name="description">{{old('description') ?? $service->description}}</textarea>
