...
Route::get('/image/upload',[RoomImagesController::class,'fileCreate'])->name('index');
Route::post('/image/upload/store',[RoomImagesController::class,'fileStore'])->name('store');
Route::post('/image/delete',[RoomImagesController::class,'fileDestroy'])->name('delete');
