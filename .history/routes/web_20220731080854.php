...
Route::get('/image1/view',[RoomImagesController::class,'fileCreate'])->name('view');
Route::post('/image1/upload/store',[RoomImagesController::class,'fileStore'])->name('store');
Route::post('/image1/delete',[RoomImagesController::class,'fileDestroy'])->name('delete');
