...
Route::middleware(['auth'])->group(function() {
    ...
    Route::prefix('admin')->group(function () {
        ...
        Route::prefix('room')->name('room.')->group(function () {
            ...
            Route::get('edit/{id?}', [RoomController::class,'update'])->name('update');
            Route::get('/search',[StaffController::class,'search'])->name('search');


            Route::get('image/upload',[RoomController::class,'fileCreate'])->name('create-file');
            Route::post('image/upload/store',[RoomController::class,'fileStore'])->name('store-file');
            Route::post('image/delete',[RoomController::class,'fileDestroy'])->name('destroy-file');
