...
Route::get('/login', [RoomImagesController::class,'fileCreate'])->name('login');
...
Route::get('/image/upload',[RoomImagesController::class,'fileCreate']);
Route::post('/image/upload/store',[RoomImagesController::class,'fileStore']);
Route::post('/image/delete',[RoomImagesController::class,'fileDestroy']);
// Route::post('image/upload/store','RoomImagesController@fileStore');
// Route::post('image/delete','RoomImagesController@fileDestroy');
