...
Route::get('/booking',[BookingController::class,'getBooking'])->name('booking');
Route::post('/booking',[BookingController::class,'postBooking'])->name('postBooking');
Route::post('/booking/confirmation',[BookingController::class,'confirmation'])->name('confirmation');
