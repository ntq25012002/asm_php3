...
Route::middleware(['auth'])->group(function() {
    ...
    Route::prefix('admin')->group(function () {
        ...
        Route::prefix('equipment')->name('equipment.')->group(function() {
            ...
            Route::get('delete-equipments', [StaffController::class,'deleteEquipments'])->name('delete-equipments');
            Route::get('/search',[StaffController::class,'search'])->name('search');
        ...
        Route::prefix('room-type')->name('room-type.')->group(function() {
            ...
            Route::get('delete-room-types', [StaffController::class,'deleteRoomTypes'])->name('delete-room-types');
            Route::get('search',[StaffController::class,'search'])->name('search');
        });
        ...
        Route::prefix('slider')->name('slider.')->group(function() {
            ...
            Route::get('delete-sliders', [StaffController::class,'deleteSliders'])->name('delete-sliders');
            Route::get('search',[StaffController::class,'search'])->name('search');
        });
