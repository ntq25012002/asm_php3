...
Route::middleware(['auth'])->group(function() {
    ...
    Route::prefix('admin')->group(function () {
        ...
        Route::prefix('equipment')->name('equipment.')->group(function() {
            Route::get('/{keyword?}', [EquipmentController::class,'index'])->name('index');
    ...
    // Route::get('image/upload','RoomController@fileCreate');
    Route::post('image/upload/store','RoomController@fileStore');
    Route::post('image/delete','RoomController@fileDestroy');
});
