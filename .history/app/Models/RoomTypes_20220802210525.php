...
class RoomTypes extends Model
{
    ...
    public function loadList($params = []) {
        $query =  DB::table($this->table)
                ...
                ->select('room_types.*','equipments.id as id_equipment','equipments.name as equipment','room_type_equipment.quantity_equipment','room_type_equipment.id as id_room_type_equipment')
                ->join('equipments','room_type_equipment.equipment_id','=','equipments.id')
                ->where('id_equipment','id_room_type_equipment')
