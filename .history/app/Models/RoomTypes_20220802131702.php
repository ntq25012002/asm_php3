...
class RoomTypes extends Model
{
    use HasFactory;
    use SoftDeletes;
    protected $fillable = ['name','image','description','adults','children','equipments.name','room_type_equipment.quantity_equipment'];
    ...
    public function loadList($params = []) {
        $query = DB::table($this->table)
                ...
                ->join('equipments','equipments.id','=','room_types')
