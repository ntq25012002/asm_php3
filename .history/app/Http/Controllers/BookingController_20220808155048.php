...
class BookingController extends Controller
{
    ...
    public function bookingDetail($id) {
        ...
        if($booking) {
            ...
            return redirect()->route('admin.booking.index')->with('err','Không xác định đơn đặt phòng');
        }
    }
    ...
    public function update($id,Request $request) {
        ...
        if($res) {
            return redirect()->route('admin.booking.edit',['id' => $id])->with('msg','Cập nhật thông tin đơn đặt phòng thành công!');
        }else{
            return redirect()->route('admin.booking.edit',['id' => $id])->with('err','Lỗi cập nhật!');
        }
    }
