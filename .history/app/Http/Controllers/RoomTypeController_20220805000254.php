...
class RoomTypeController extends Controller
{
    ...
    public function listRoomType($id) {
        $list = $this->roomTypes->loadListRoomType($id);
        $this->v['roomTypes'] = $list;
    ...
    public function store(RoomTypeRequest $request) {
        try {
            ...
            DB::rollback();
            return redirect()->route('room-type.create')->with('err','Thêm mới thất bại');
        }
    ...
    public function edit($id) {
        ...
        if($roomType) {
            ...
            return redirect()->route('room-type.index')->with('err','Không xác định bản ghi cần cập nhật');
        }
    }
    ...
    public function update(RoomTypeRequest $request,$id) {
        try {
            ...
            return redirect()->route('room-type.edit', $id)->with('err','Sửa không thành công');
        }
    }
