...
class BookingController extends Controller
{
    ...
    public function getBooking(Request $request) {
        ...
        if(Session::has('roomBooking')) {
            ...
            $this->v['checkinD'] = $datediffCheckin['tm_wday'] == 0? 'Chủ nhật':'Thứ '.$datediffCheckin['tm_wday']+1;
            $this->v['checkoutD'] = $datediffCheckout['tm_wday'] == 0? 'Chủ nhật':'Thứ '.$datediffCheckout['tm_wday']+1;
