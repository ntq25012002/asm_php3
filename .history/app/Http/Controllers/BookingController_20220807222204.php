...
class BookingController extends Controller
{
    ...
    public function getBooking(Request $request) {
        ...
        if(Session::has('roomBooking')) {
            ...
            dd($datediffCheckin['tm_mon']+1 .'/'. $datediffCheckin['tm_year'] + 1900);
            // {{$checkin['tm_mon']+1}}/{{$checkin['tm_year'] + 1900}}
            ...
            $this->v['monthYear'] = $datediffCheckin['tm_mon']+1 .'/'. $datediffCheckin['tm_year'] + 1900;
